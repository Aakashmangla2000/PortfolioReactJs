...
class Hobbies extends Component {
    constructor(props) {
        ...
        this.state = {
             ...
             hob: [
                 {'name':'Cubing',"link":"https://image.flaticon.com/icons/svg/2532/2532683.svg","img":"BEDE4C6F-B72F-4FAE-A0F4-8241067A55E8_1_105_c.jpeg"},
                 {'name':'Cooking','link':"https://image.flaticon.com/icons/svg/817/817282.svg","img":"IMG_8078.jpeg"},
                 {'name':'Photography','link':'https://image.flaticon.com/icons/svg/2990/2990729.svg',"img":"IMG_7860.jpeg"},
                 {"name":"Music","link":"https://image.flaticon.com/icons/svg/3010/3010957.svg","img":"IMG_6522.jpeg"},
                 {"name":"Art","link":"https://image.flaticon.com/icons/svg/2972/2972213.svg","img":"DDCL0803.jpeg"}
                ]
        }
            ...
            return(
                <div className="hob-list">
                    <li className="li-item" onMouseEnter={()=>this.setIndex(ind)}>
                        <h7>{el.name} <img className="hob-logo animate__fadeIn" src={el.link}></img></h7>
                    </li>
                </div>
            )
        })
                ...
                <div className="row rr">
                    ...
                    <div className="col-md-6">
                        <div className="photo-frame">
                            <img className="photo" src={`images/${this.state.hob[this.state.index].img}`}></img>
                        </div>
                    </div>
                </div>
                <br></br>
