        ...
        <li>
          <div class="direction-l">
            ...
            <div class="desc">
              ...
              <br />
              •Implemented Web APIs using ASP.NET Core, Repository Pattern and
              MVC Architecture successfully. <br />
              •Worked with Team Apollo on the products Market EyeQ and
              Enterprise EyeQ. <br />
              •Collaborated on more than 10 features with the team and wrote
              unit and integration tests for the same.
            </div>
          </div>
        </li>
        <li>
        ...
        <li>
          <div class="direction-l">
            ...
            <div class="desc">
              ...
              <br></br>
              •Collaborated with the team in development of new features as per
              the business requirements.
              <br></br>
              •TechnologiesUsed-ReactJS,NextJS,SpringBoot,CircleCI,GCP,PostgreSQL.
              <br></br>
            </div>
          </div>
        </li>
