    ...
    this.state = {
      skills: [
        ...
        },
        {
          ...
          link: "https://cdn-icons-png.flaticon.com/512/646/646460.png",
        },
        {
          name: "Back-End",
          sub: [
          ...
          link: "https://cdn-icons-png.flaticon.com/512/2165/2165703.png",
        },
      ],
      index: 0,
    };
    ...
    let list2 = this.state.skills.map((el, ind) => {
      return (
        <div
          className="left-list"
          onMouseEnter={() => {
            this.hoverElement(ind);
          }}
        >
          <li>
            <h4>
              {el.name} <img className="logo" src={el.link}></img>
            </h4>
          </li>
        </div>
      );
